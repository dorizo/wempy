            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form method="post" action="{{ route('beritavideo.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" name="link" value="{{ old('link') }}">
