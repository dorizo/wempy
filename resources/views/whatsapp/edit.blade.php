            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form method="post" action="{{ route('whatsapp.update' , $single->whatsappCode) }}">
                        @csrf
                        @method("PUT")
                        ...
                        <input type="text" class="form-control @error('whatsappName') is-invalid @enderror" name="whatsappName" value="{{ $single->whatsappName }}">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <textarea class="form-control @error('WhatsappDesc') is-invalid @enderror"  name="WhatsappDesc">{{ $single->WhatsappDesc}}</textarea>
