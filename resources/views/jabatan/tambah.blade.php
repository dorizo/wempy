                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form method="post" action="{{ route('jabatan.store') }}">
                        ...
                        <input type="text" class="form-control @error('jabatanName') is-invalid @enderror" name="jabatanName" value="{{ old('jabatanName') }}">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control @error('jabatanDesc') is-invalid @enderror"  name="jabatanDesc" value="{{ old('jabatanDesc') }}">
